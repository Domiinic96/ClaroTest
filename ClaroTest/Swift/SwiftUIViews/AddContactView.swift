               ...
               ScrollView {
                   VStack(spacing: 20) {
                       ...
                       VStack(spacing: 0) {
                           ...
                           customField(title: Constants.nombre, text: $vm.name)
                               .focused($focusedField, equals: .name)
                           divider
                           customField(title: Constants.apellido, text: $vm.lastName)
                               .focused($focusedField, equals: .lastName)
                           divider
                           customField(title: Constants.telefono, text: $vm.phone)
